# ESP32 智能小车（OV7670、Tb6612fng）

这是一个基于 ESP32 的摄像头监控系统，能够提供 Web 界面访问、实时视频流传输和拍照功能。使用到的硬件有ESP 32 S3 N16R8，OV7670（无FIFO）18脚版本，Tb6612fng双路电机驱动。

**重要提示！！！！：初始入门建立的项目，未完善，建仓主要是为了交流和自我学习。**
